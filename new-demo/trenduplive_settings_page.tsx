...
import { 
  ArrowLeft, Bell, Shield, Wallet, Moon, 
  ChevronRight, LogOut, User, Globe, HelpCircle 
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#040508] text-white font-sans p-4">
      ...
      <div className="flex flex-col gap-8">
              ...
              {section.items.map((item, i) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    <item.icon className="w-5 h-5 text-[#8B8D93]" />
        ...
        {/* Logout Button */}
        <button className="flex items-center gap-4 p-4 text-[#FF3B30] font-bold border border-[#1C1E23] rounded-[16px] bg-[#0A0D12]">
