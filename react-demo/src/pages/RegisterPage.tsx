...
import { User, Lock, Eye, EyeOff, ShieldCheck, Wallet, MoreHorizontal, ChevronDown, ChevronUp } from 'lucide-react';
      ...
      <div className="w-full max-w-[440px] bg-[#0C0D11] border border-[#1A1C22] rounded-[2rem] p-6 sm:p-8 z-10 shadow-2xl">
        ...
        <div className="flex flex-col gap-[14px]">
          ...
          <button
            ...
            className="w-full flex items-center justify-between h-[56px] px-5 bg-transparent border border-[#23252A] rounded-2xl hover:bg-[#15171C] transition-colors group"
          >
            ...
            {showMore ? <ChevronUp className="w-5 h-5 text-[#8B8D93]" strokeWidth={2.5} /> : <ChevronDown className="w-5 h-5 text-[#8B8D93]" strokeWidth={2.5} />}
          </button>
          ...
          {showMore && (
            <div className="flex flex-col gap-[14px]">
              ...
              >
                <AppleIcon className="w-[22px] h-[22px] text-white ml-1 mr-4" />
                <span className="text-[#E0E0E0] text-[16px] font-medium">Create with Apple</span>
              </button>
              ...
              <button
                ...
                className="w-full flex items-center h-[56px] px-5 bg-transparent border border-[#23252A] rounded-2xl hover:bg-[#15171C] transition-colors group"
              >
                <GitHubIcon className="w-[22px] h-[22px] text-white mr-4" />
                <span className="text-[#E0E0E0] text-[16px] font-medium">Create with GitHub</span>
              </button>
            </div>
          )}
        </div>
